      ...
      <div className="flex flex-col md:flex-row w-full max-w-5xl bg-white rounded-3xl overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
        ...
        <div className="flex flex-col justify-center w-full md:w-1/2 p-8 md:p-14 lg:p-20">
          <div className="max-w-md w-full mx-auto">
            <h2 className="text-3xl font-bold text-[#0c1e3a] mb-2">Reset Password</h2>
            <p className="text-gray-500 mb-10 text-sm">Please enter your new password below.</p>
            
            <form className="space-y-5" onSubmit={handleSubmit}>
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-[#0c1e3a]" htmlFor="new-password">
                  New Password
                </label>
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-semibold text-[#0c1e3a]" htmlFor="confirm-password">
                  Confirm Password
                </label>
                <div className="relative">
                  <input
