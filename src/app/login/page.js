        ...
        <div className="flex flex-col justify-center w-full md:w-1/2 p-8 md:p-14 lg:p-20">
          <div className="max-w-md w-full mx-auto">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 text-sm rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all pr-10 placeholder:text-gray-400"
                    required
                  />
                  <button
                    type="button"
            ...
            <div className="mt-8 text-center">
              <a href="#" className="text-sm font-semibold text-[#1b64f2] hover:text-blue-700 transition-colors">
                Forgot Password?
              </a>
            </div>
